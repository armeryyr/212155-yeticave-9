        ...
        <nav class="user-menu">
           <?php if($is_auth == 1):?>
            <div class="user-menu__logged">
                ...
                <a class="user-menu__bets" href="pages/my-bets.html"><?= $user_name; ?></a>
...
<main class="container">
    ...
    <section class="lots">
        ...
        <?php function formatting_number($price){
            ...
            ceil($price);
            return $price = $nombre_format_francais = number_format($price, 0, ',', ' ') . " ";
            }
        ?>
        <ul class="lots__list">
            <?php $lots = [
            ...
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    <span class="lot__category"></span><?=$value['Категория'];?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$value['Название'];?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=formatting_number($price);?><b class="rub">р</b></span>
                        </div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            ?>
            <li class="nav__item">
                <a href="pages/all-lots.html"><?=$categories[$category];?></a>
            </li>
            <?php endforeach; ?>
        </ul>
    </nav>
