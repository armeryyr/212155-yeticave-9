...
VALUES
  ('2019-05-07','2014 Rossignol District Snowboard', 'Лот №1', 'img/lot-1.jpg', '10999', '2019-05-08', '100', '1', '1', '0'),
  ('2019-05-07', 'DC Ply Mens 2016/2017 Snowboard', 'Лот №2', 'img/lot-2.jpg', '159999', '2019-05-08', '100', '2',  '1', '0'),
  ...
  ('2019-05-07', 'Куртка для сноуборда DC Mutiny Charocal', 'Лот №5', 'img/lot-5.jpg', '7500', '2019-05-08', '100', '5',
   '4', '0'),
  ('2019-05-07', 'Маска Oakley Canopy', 'Лот №6', 'img/lot-6.jpg', '5400', '2019-05-08', '100', '6', '5', '0');
...
SELECT lots.name, price_initial, img, categories.name, MAX(price_user), data_end FROM lots
